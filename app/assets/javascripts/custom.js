$(document).ready(function(){	 
	kriesi_tab('#content','.jQuery_tab_title','.jQuery_tab'); /*remove this if you dont want to have $ tabs*/
...
$(title).each(
					  function(i){
						 if (i == 0){
						$(wrapper).prepend("<div class='$_tab_container'><a href='/' class='heading_tab advanced_link active tab"+(i+1)+"'>"+$(this).html()+"</a></div>");
							}else{
